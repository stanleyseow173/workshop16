...
public class Mastermind implements Serializable{
    ...
    public void setPieces(Pieces pieces) {this.pieces = pieces;}
    ...
    public void setUpSert(boolean isUpSert) {this.isUpSert = isUpSert;}
    ...
    public JsonObject toJSONInsert(){
        return Json.createObjectBuilder()
            .add("id", this.getId())
            .add("inset_count", this.getInsertCount())
            .build();
    }
